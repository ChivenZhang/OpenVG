...
public:
	...
	void drawLines(UIArrayView<UILine> lines) override;
	...
	void drawPoints(UIArrayView<UIPoint> points) override;
	void drawPolygon(UIArrayView<UIPoint> points) override;
	void drawPolyline(UIArrayView<UIPoint> points) override;
	void drawRect(float x, float y, float width, float height) override;
	void drawRects(UIArrayView<UIRect> rects) override;
	...
	VGContextRaw getVGContext() const;
